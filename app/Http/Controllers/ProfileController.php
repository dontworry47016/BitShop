...
class ProfileController extends Controller
{
    ...
    public function storePGP(StorePGPRequest $request)
    {
        try{
            $request -> persist();
            session() -> flash('success', 'Successfully changed PGP key.');
        }
        catch(RequestException $e){
            session() -> flash('errormessage', $e -> getMessage());
            return redirect() -> back();
    ...
    public function change2fa($turn)
    {
        try{
            ...
            session() -> flash('success', 'Successfully toggled 2FA.');
        }
        catch (RequestException $e){
            session() -> flash('errormessage', $e -> getMessage());
        }
    ...
    public function addToCart(NewItemRequest $request, Product $product)
    {
        try{
            ...
            session() -> flash('success', 'Successfully added/changed an item.');
    ...
    public function makeDispute(MakeDisputeRequest $request, Purchase $purchase)
    {
        try{
            ...
            session() -> flash('success', 'successfully disputed for this purchase.');
        }
        catch (RequestException $e){
            $e -> flashError();
        }
    ...
    public function newDisputeMessage(NewDisputeMessageRequest $request, Dispute $dispute)
    {
        try{
            ...
            session() -> flash('success', 'You have successfully posted a new message for this dispute.');
        }
        catch (RequestException $e){
            $e -> flashError();
        }

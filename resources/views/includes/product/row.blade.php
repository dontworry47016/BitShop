<div class="row my-2">
    ...
    <div class="col-md-9 col-sm-8 col-12">
        <div class="row pb-2 mb-2 border-bottom border-light">
            ...
            <div class="col-md-4">
                <h5 class="mb-0 text-right"><a href="{{ route('vendor.show', $product -> user) }}"><img class="image rounded-circle" src="{{asset('/storage/images/'.$product->user->image)}}" alt="" style="width: 25px; height: 25px; padding: 0px; margin: 0px; "> {{ $product -> user -> username }}</a></h5>
            </div>
        </div>
            ...
            <div class="col-md-5">
                ...
                <p>
                    ...
                    @foreach($product -> getCoins() as $coin)
                        <span class="badge badge-primary">{{ strtoupper(\App\Purchase::coinDisplayName($coin)) }}</span>
                    @endforeach
                </p>

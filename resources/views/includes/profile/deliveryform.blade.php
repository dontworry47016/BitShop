    ...
    <table class="table table-striped table-hover">
        ...
        @foreach($productsShipping as $shipping)
            <tr>
                ...
                <td class="text-right">
                    @if($shipping -> exists)
                        <a href="{{ route('profile.vendor.product.delivery.remove', [$shipping -> id, $physicalProduct] ) }}" class="btn btn-sm btn-red">Remove</a>
                    @else
                        <a href="{{ route('profile.vendor.product.delivery.remove', $i) }}" class="btn btn-sm btn-red">Remove</a>
                    @endif
                </td>
            </tr>
            @php
...
@else
    <div class="alert alert-warning">You don't have any shipping options, please add at least one.</div>
@endif
    ...
    <div class="form-row">
       ...
       <div class="col-md-4 my-2">
        ...
        <div class="col-md-4 my-2 text-right">
            <button class="btn btn-primary" type="submit"><i class="fas fa-plus mr-2"></i> Add shipping</button>
        </div>
    </div>
</form>

<h3 class="mt-3">Countries</h3>
<hr>
<form method="POST" action="{{ route('profile.vendor.product.delivery.options', $physicalProduct) }}">
    ...
    <div class="form-row">
        ...
        <div class="col-md-4 my-2">
            <label for="countries">Included/excluded:</label>
        ...
        <div class="col-md-4 my-2">
            <label for="country_from">Ships from:</label>
    ...
    <div class="form-row justify-content-center">
        <div class="col-md-3 text-center">
            ...
            @if(request() -> is('profile/vendor/product/edit/*'))
                <button class="btn btn-primary" type="submit"><i class="far fa-save mr-2"></i> Save</button>
            ...
            @else
                <button class="btn btn-primary" type="submit"><i class="fas fa-chevron-down mr-2"></i>  Next</button>
            @endif
        </div>
    </div>
</form>

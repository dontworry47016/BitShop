<div class="row mt-2">
    <div class="col-md-6">
        ...
        <table class="table">
            ...
            <tr>
                <td>
                    <span class="fas fa-thumbs-up text-success"></span> Positive
                </td>
                <td>
            ...
            <tr>
                <td>
                    <span class="fas fa-minus text-secondary"></span>  Neutral
                </td>
                <td>
            ...
            <tr>
                <td>
                    <span class="fas fa-thumbs-down text-danger"></span> Negative
                </td>
                <td>

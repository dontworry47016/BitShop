    ...
    <div class="row mt-1 mb-3">
        <div class="col">
            <form action="{{route('admin.tickets.remove')}}" method="post">
                {{csrf_field()}}
                <button type="submit" class="btn btn-red" name="type" value="solved">Remove solved tickets</button>
                <button type="submit" class="btn btn-red" name="type" value="all">Remove all tickets</button>
                ...
                <div class="input-group mb-3 mt-2">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-red" type="submit" name="type" value="orlder_than_days">Remove all</button>
                    </div>
                </div>
        ...
        @foreach($tickets as $ticket)
            <tr>
                <td>
                    ...
                    @if($ticket -> solved)
                    <span class="badge badge-primary">Solved</span>
                    @else
                        @if($ticket -> answered)

...
class walletRPC
{
   ...
   *
   */
  function __construct($host = '127.0.0.1', $port = 18081, $SSL = false, $user = 'market', $password = 'ikv88evD7aN0lrSh30BMtwkGLDx97IY0AiG6Q7uW2qaLSYDDBm')
  {
   ...
   *
   */
  public function transfer($destinations, $payment_id = '', $mixin = 15, $account_index = 0, $subaddr_indices = '', $priority = 2, $unlock_time = 0, $do_not_relay = false, $ringsize = 11)
  {
